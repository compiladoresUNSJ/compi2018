...
namespace at.jku.ssw.cc
{
    ...
    class Parser
    {
        ...
        static void Program()
        {
            //Inicializacion de la pila que muestra por cual regla de la gramatica se est� pasando
            ...
            //Grupo Cocinero, Ledesma. A�o 2018. Inicio
            ListViewItem itm;
            itm = new ListViewItem("0");
            Program1.form1.Pila_de_Llamados.Items.Add(itm);// Agrega el numero de regla en la pila de llamadas de la gram�tica
            //Fin
            ...
            while (la != Token.LBRACE && la != Token.EOF) //Si no existen declaraciones, la = Token.LBRACE
            {
                ...
                Program1.form1.Pila_de_Llamados.Items.Add(itm1);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                Parser.MessageBoxCon3Preg();
                ...
                Program1.form1.Pila_de_Llamados.Items.Add(itm2);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                    ...
                    case Token.IDENT:  //Type ident..
                        {
                            ...
                            Program1.form1.Pila_de_Llamados.Items.Add(itm6);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                            ...
                            Program1.form1.Pila_de_Llamados.Items.Add(itm12);// Agrega el numero de regla en la pila de llamadas de la gram�tica
            ...
            Program1.form1.Pila_de_Llamados.Items.Add(itm3);// Agrega el numero de regla en la pila de llamadas de la gram�tica
            ...
            MessageBoxCon3Preg();
            Program1.form1.Pila_de_Llamados.Items.Remove(itm3);
        ...
        {  //visto  //si es "int[] pos" y viene de "Class Tabla {", kind es "Field"
            ...
            Program1.form1.Pila_de_Llamados.Items.Add(itm13);// Agrega el numero de regla en la pila de llamadas de la gram�tica
            //Fin
        ...
        static void MethodDecl(System.Windows.Forms.TreeNode methodDeclsopc)
        {
            ...
            if (la == Token.VOID || la == Token.IDENT)
            {
                if (la == Token.VOID)
                {
                    ...
                    Program1.form1.Pila_de_Llamados.Items.Add(itm9);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                    //Fin
                    ...
                    Program1.form1.Pila_de_Llamados.Items.Remove(itm9);
                    MessageBoxCon3Preg();
                ...
                Program1.form1.Pila_de_Llamados.Items.Add(itm10);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                ...
                else
                {
                    ...
                    MessageBoxCon3Preg();
                    Code.seleccLaProdEnLaGram(8);
                    Program1.form1.Pila_de_Llamados.Items.Remove(itm10);//Quito el 10 para volver a 8
                    MessageBoxCon3Preg();
                    methodDecl.Nodes.Add("')'");
                    MessageBoxCon3Preg();
                }
                ...
                //Arreglado por Grupo Cocinero, Ledesma. A�o 2018. Inicio
                ...
                ListViewItem itm1rec;
                itm1rec = new ListViewItem("1");
                Program1.form1.Pila_de_Llamados.Items.Add(itm1rec);// Agrega el numero 1 a la pila, ya que la regla 1 "PosDeclars" se esta llamando recursivamente
                MessageBoxCon3Preg();
                ...
                Program1.form1.Pila_de_Llamados.Items.Remove(itm1rec);
                MessageBoxCon3Preg();
                ...
                //Fin arreglo Grupo Cocinero, Ledesma. A�o 2018.
        ...
        static void Statement(System.Windows.Forms.TreeNode statement)
        {
            ...
            if (la == Token.IDENT)
            {
                ...
                // Agrega el numero de regla en la pila de llamadas de la gram�tica
                //-------------------------------------------------Grupo 2 28/9/2015-----------------------------------------------------------
                ...
                Program1.form1.Pila_de_Llamados.Items.Add(itm22);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                MessageBoxCon3Preg();
                //Fin
                //-------------------------------------------------Grupo 2 28/9/2015-----------------------------------------------------------
                if (ZZ.parser)
                ...
                switch (la)
                {
                    ...
                    case Token.SAY:
                        {
                            ...
                            {
                                Errors.Error("Se esperaba una apertura de par�ntesis '('");
                            }
                        }
                        break;
                    ...
                    case Token.WRITE: ///  En Statement
                        ...
                        else
                        {
                            ...
                            Program1.form1.Pila_de_Llamados.Items.Remove(itm22);
        ...
        static void Block(System.Windows.Forms.TreeNode methodDecl)
        {
            ...
            Program1.form1.Pila_de_Llamados.Items.Add(itm17);// Agrega el numero de regla en la pila de llamadas de la gram�tica
            MessageBoxCon3Preg();
            //Fin
            ...
            while (la != Token.RBRACE)
            {
                  ...
                  || la == Token.LBRACE || la == Token.SEMICOLON) && la != Token.EOF )
                {
                    ...
                    Program1.form1.Pila_de_Llamados.Items.Add(itm18);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                    MessageBoxCon3Preg();
                    //Code.seleccLaProdEnLaGram(18);
                    //Fin
                ...
                Program1.form1.Pila_de_Llamados.Items.Remove(itm18);
            ...
            Program1.form1.Pila_de_Llamados.Items.Remove(itm17);
        ...
        static void Expr(out Item item, System.Windows.Forms.TreeNode padre)
        {
            ...
            if (la == Token.MINUS)
            {
                ...
                itm24 = new ListViewItem("24"); //Le asignamos el n�mero correspondiente
                Program1.form1.Pila_de_Llamados.Items.Add(itm24); // Agregamos el numero de regla en la pila de llamadas de la gram�tica
                Code.seleccLaProdEnLaGram(24);
                MessageBoxCon3Preg(); 
                OpcMinus.Nodes.Add("-");
                MessageBoxCon3Preg(padre);
                MessageBoxCon3Preg();
                Program1.form1.Pila_de_Llamados.Items.Remove(itm24); // Quitamos el item correspondiente
                Code.seleccLaProdEnLaGram(23);
                MessageBoxCon3Preg();
                //Fin
            ...
            itm25 = new ListViewItem("25"); //Le asignamos el n�mero correspondiente
            Program1.form1.Pila_de_Llamados.Items.Add(itm25); // Agregamos el numero de regla en la pila de llamadas de la gram�tica
            ...
            while ((la == Token.PLUS || la == Token.MINUS) && la != Token.EOF)
            {
                ...
                itm33 = new ListViewItem("33"); //Le asignamos el n�mero correspondiente
                Program1.form1.Pila_de_Llamados.Items.Add(itm33); // Agregamos el numero de regla en la pila de llamadas de la gram�tica
        ...
        static void Term(out Item item)
        {
            ...
            itm34 = new ListViewItem("34"); //Le asignamos el n�mero correspondiente
            //Fin
            //Fin
            ...
            if (la == Token.IDENT || la == Token.NUMBER || la == Token.CHARCONST || la == Token.NEW || la == Token.LPAR)
            {
                ...
                while ((la == Token.TIMES || la == Token.SLASH || la == Token.REM) && la != Token.EOF)
                {
                    ...
                    Program1.form1.Pila_de_Llamados.Items.Add(itm27);// Agrega el numero de regla en la pila de llamadas de la gram�tica
                        ...
                        case Token.TIMES:
                            {
                                ...
                                Program1.form1.Pila_de_Llamados.Items.Add(itm34); // Agregamos el numero de regla en la pila de llamadas de la gram�tica
                                //Fin
                                MessageBoxCon3Preg();
                                break;
                            }
        ...
        static void Term(out Item item, System.Windows.Forms.TreeNode padre)
        {
            ...
            if (la == Token.IDENT || la == Token.NUMBER || la == Token.CHARCONST || la == Token.NEW || la == Token.LPAR)
            {
                ...
                itm27 = new ListViewItem("27"); //Le asignamos el n�mero correspondiente
                Program1.form1.Pila_de_Llamados.Items.Add(itm27); // Agregamos el numero de regla en la pila de llamadas de la gram�tica
                Code.seleccLaProdEnLaGram(27);
                MessageBoxCon3Preg();
                //Fin
        ...
        static void Designator(out Item item, System.Windows.Forms.TreeNode padre)
        {
            ...
            Program1.form1.Pila_de_Llamados.Items.Add(itm32);// Agrega el numero de regla en la pila de llamadas de la gram�tica
            MessageBoxCon3Preg();
            ...
            Program1.form1.Pila_de_Llamados.Items.Remove(itm32);
            Code.seleccLaProdEnLaGram(31);
            MessageBoxCon3Preg();
